...
const cspDirectives = {
  ...
  'form-action': ["'self'"],
  'frame-ancestors': ["'self'", 'http://localhost:3419/', 'tauri://localhost', 'index.html'],
  'frame-src': ["'self'", 'https://www.youtube.com/', 'http://localhost:3419/', 'tauri://localhost', 'index.html'],
  'manifest-src': ["'self'"],
  'media-src': ["'self'", 'data:', '*'],
  'object-src': ["'none'"],
