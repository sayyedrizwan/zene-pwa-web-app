<script lang="ts">
  ...
  async function openNew() {
    await wait(1000)
    alert('Please note \n\n We have registered your request it can take 5-10 days to process your request. A confirmation mail will be send to your mail account. \n\nYou will be redirected to zene homepage')
    window.location.href = 'https://zenemusic.co'
  }
</script>
...
<div class="relative mx-auto w-full pt-20 text-center pb-24 text-white rounded-lg">
  <h1 class="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">Delete Data/Account on Zene</h1>
</div>

<form class="max-w-lg mx-auto bg-white p-5" id="deleteform">
  ...
  <div class="grid md:grid-cols-2 md:gap-6">
    <div class="relative z-0 w-full mb-5 group">
      ...
      <label
        for="floating_phone"
        class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
        >Why do you want to delete?</label
      >
    </div>
    <div class="relative z-0 w-full mb-5 group">
      <input
      ...
      <label
        ...
        class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
        >What can be improved on Zene</label
      >
    </div>

    <button type="submit" value="Submit" class="bg-black w-24 h-11 text-white" on:click={openNew}>Submit</button>
  </div>
</form>
