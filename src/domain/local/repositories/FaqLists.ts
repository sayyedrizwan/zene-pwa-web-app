...
export class FaqListsRepository implements FaqRepositoryInterface {
  getAllFaqs(): FaqData[] {
    return [
      new FaqData(
        'Can I sign up for free? What are the different subscription plans available?',
        'User can streaming music, videos, lyrics, and more on Zene all without the hassle of mandatory signups or logins execpt when you start a group party. Also our vast library of content on the Zene Android, iOS, and Web apps are accessible without any subscription fees.',
      ),
      new FaqData(
        'How do I import my music library from another platform?',
        'On the Zene app for Android and iOS, users can seamlessly import playlists from three major platforms: Spotify, YouTube Music, and Apple Music. For the Zene Web App, playlist importing is currently available exclusively from Spotify.',
      ),
