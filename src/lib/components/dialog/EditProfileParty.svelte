    ...
    <div class="relative p-4 w-full">
      <div class="relative bg-white rounded-lg w-full">
        ...
        <div class="p-4 md:p-5 space-y-4 flex flex-col justify-center items-center">
          ...
          <button on:click={uploadImage}><p class="text-maincolor urbanist-thin text-base break-words my-3 mx-3 truncate line-clamp-2 text-center">update profile picture</p></button>
