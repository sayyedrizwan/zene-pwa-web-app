...
{:else if music.type == "SONGS"}
  ...
  <div class="fixed bottom-28 right-3 z-50 cursor-pointer flex justify-center items-center">
    <div class="relative">
      ...
      <div role="status" class="absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mb-4">
        <svg aria-hidden="true" class="size-7 fill-white text-gray-200 animate-spin fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
